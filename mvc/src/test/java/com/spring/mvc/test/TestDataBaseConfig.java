...
@ComponentScan({"com.spring.mvc", "com.spring.mvc.test"})
public class TestDataBaseConfig {

    private static final String PROPERTY_NAME_DATABASE_DRIVER = "org.postgresql.Driver";
    private static final String PROPERTY_NAME_DATABASE_URL = "jdbc:postgresql://localhost:5432/loan?useSSL=false";
    ...
    private static final String PROPERTY_NAME_ENTITYMANAGER_PACKAGES_TO_SCAN = "com.model.entities";
